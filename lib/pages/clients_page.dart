...
class _ClientsPageState extends State<ClientsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<Clients>(
          //Criando um consumer para manter o estado dos dados aliado ao provider.
  ...
  void createType(context) {
    ...
    Types listTypes = Provider.of<Types>(context, listen: false);  //Usando o provider dentro de um método.
